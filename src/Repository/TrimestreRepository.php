...
class TrimestreRepository extends ServiceEntityRepository
{
    ...
    public function add(Trimestre $entity, bool $flush = false): void
    {
    ...
    public function remove(Trimestre $entity, bool $flush = false): void
    {
    ...
    public function findTrimestre($idAnnee)
    {
        $connexion = $this->_em->getConnection();
        $requete = "SELECT * FROM `trimestre` WHERE annee_id = $idAnnee";
